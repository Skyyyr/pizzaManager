...
class Pizza(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['pizza_owner', 'pizza_name'], name='unique_pizza_owner_name'),
            models.UniqueConstraint(fields=['pizza_owner', 'topping_list'], name='unique_pizza_owner_topping')
        ]
